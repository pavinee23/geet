...
const LANGUAGE_OVERRIDES = {
  ...
  vi: {
    nav: { about: 'Gi?i thi?u', services: 'D?ch v?', products: 'S?n ph?m', technology: 'Công ngh?', contact: 'Liên h?', admin: 'Admin', register: '??ng ký n?n t?ng', signIn: '??ng nh?p n?n t?ng' },
    hero: { tag: 'N?ng l??ng thông minh · IoT · ??i m?i xanh', title1: 'N?ng l??ng thông minh', title2: 'cho m?t', title3: 't??ng lai b?n v?ng', cta1: 'Xem d?ch v?', cta2: 'Liên h?', stats: ['Thi?t b? giám sát', 'Khách hàng doanh nghi?p', 'Cam k?t uptime', 'Qu?c gia ph?c v?'] },
    services: { badge: 'D?ch v? c?a chúng tôi', title: ['Gi?i pháp tích h?p', 'cho m?i doanh nghi?p'], sub: 'D?ch v? tr?n gói t? phát tri?n thi?t b? IoT ??n n?n t?ng giám sát và phân tích n?ng l??ng b?ng AI.' },
    products: { badge: 'S?n ph?m', title: ['??i m?i', 'S?n ph?m n?ng l??ng'], sub: 'Thi?t b? và h? th?ng do k? s? GE Energy Tech thi?t k? ?? t?i ?u hi?u qu? n?ng l??ng.', inquiry: 'H?i v? s?n ph?m' },
    tech: { badge: 'Công ngh? s? d?ng', title: ['Xây d?ng b?ng', 'công ngh? hàng ??u'], sub: '??i m?i liên t?c v? công ngh? n?ng l??ng m?i h? tr? chuy?n ??i xanh và Net Zero.' },
    contact: { badge: 'Liên h?', title: ['S?n sàng b?t ??u', 'd? án c?a b?n?'], head: 'Hãy trao ??i v?i chúng tôi', sub: '??i ng? s?n sàng t? v?n, thi?t k? và báo giá mi?n phí.', submit: 'G?i tin nh?n ?', sending: '?ang g?i...', success: '?ã g?i tin nh?n. Chúng tôi s? ph?n h?i qua email.', error: 'G?i th?t b?i. Vui lòng th? l?i.' },
    footer: { services: 'D?ch v?', systems: 'H? th?ng', rights: 'M?i quy?n ???c b?o l?u.', privacy: 'Quy?n riêng t?', terms: '?i?u kho?n', portals: 'C?ng h? th?ng' },
  },
  ko: {
    nav: { about: '?? ??', services: '???', products: '?? ??', technology: '??', contact: '??', admin: 'Admin', register: '??? ??', signIn: '??? ???' },
    hero: { tag: '??? ??? · IoT · ?? ??', title1: '??? ???', title2: '?????', title3: '??? ??', cta1: '??? ??', cta2: '????', stats: ['???? ??', '?? ??', '??? ??', '??? ??'] },
